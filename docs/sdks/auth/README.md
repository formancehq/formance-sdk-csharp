...
var res = await sdk.Auth.GetServerInfoAsync();
...
var res = await sdk.Auth.ListClientsAsync();
...
var res = await sdk.Auth.CreateClientAsync(req);
...
var res = await sdk.Auth.ReadClientAsync(clientId: "<id>");
...
var res = await sdk.Auth.UpdateClientAsync(
    clientId: "<id>",
...
var res = await sdk.Auth.DeleteClientAsync(clientId: "<id>");
...
var res = await sdk.Auth.CreateSecretAsync(
    clientId: "<id>",
...
var res = await sdk.Auth.DeleteSecretAsync(
    clientId: "<id>",
    secretId: "<id>"
);
...
var res = await sdk.Auth.ListUsersAsync();
...
var res = await sdk.Auth.ReadUserAsync(userId: "<id>");
