...
namespace FormanceSDK
{
    ...
    public class Payments: IPayments
    {
        ...
        public Payments(ISpeakeasyHttpClient client, Func<FormanceSDK.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
            _securitySource = securitySource;
            _serverUrl = serverUrl;
            SDKConfiguration = config;
            V1 = new FormancePaymentsV1(_client, _securitySource, _serverUrl, SDKConfiguration);
