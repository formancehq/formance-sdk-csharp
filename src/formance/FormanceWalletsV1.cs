...
namespace formance
{
    ...
    public interface IFormanceWalletsV1
    {
        ...
        Task<Models.Requests.GetTransactionsResponse> GetTransactionsAsync(long? pageSize = null, string? walletID = null, string? cursor = null);
        ...
        /// </summary>
        Task<Models.Requests.GetHoldsResponse> GetHoldsAsync(long? pageSize = null, string? walletID = null, Dictionary<string, string>? metadata = null, string? cursor = null);
    ...
    public class FormanceWalletsV1: IFormanceWalletsV1
    {
        ...
        public FormanceWalletsV1(ISpeakeasyHttpClient client, Func<formance.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<Models.Requests.GetTransactionsResponse> GetTransactionsAsync(long? pageSize = null, string? walletID = null, string? cursor = null)
        {
        ...
        public async Task<Models.Requests.GetHoldsResponse> GetHoldsAsync(long? pageSize = null, string? walletID = null, Dictionary<string, string>? metadata = null, string? cursor = null)
        {
