    ...
    public class V2: IV2
    {
        ...
        public async Task<V2GetInfoResponse> GetInfoAsync()
        {
            ...
            else if(responseStatusCode >= 500 && responseStatusCode < 600)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<V2ErrorResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new V2GetInfoResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
        ...
        public async Task<V2ListLedgersResponse> ListLedgersAsync(long? pageSize = null, string? cursor = null)
        {
            ...
            else
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<V2ErrorResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
                    throw obj!;
                }
