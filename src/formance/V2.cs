...
namespace formance
{
    ...
    public interface IV2
    {
        ...
        /// Bulk request
        /// </summary>
        Task<V2CreateBulkResponse> CreateBulkAsync(string ledger, List<V2BulkElement>? requestBody = null);
        ...
        /// </summary>
        Task<Models.Requests.V2CreateTransactionResponse> CreateTransactionAsync(string ledger, V2PostTransaction v2PostTransaction, bool? dryRun = null, string? idempotencyKey = null);
        ...
        /// </summary>
        Task<Models.Requests.V2RevertTransactionResponse> RevertTransactionAsync(string ledger, BigInteger id, bool? force = null, bool? atEffectiveDate = null);
    ...
    public class V2: IV2
    {
        ...
        public V2(ISpeakeasyHttpClient client, Func<formance.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<V2GetInfoResponse> GetInfoAsync()
        {
            ...
            var urlString = baseUrl + "/api/ledger/v2/_info";
        ...
        public async Task<V2CreateBulkResponse> CreateBulkAsync(string ledger, List<V2BulkElement>? requestBody = null)
        {
            var request = new V2CreateBulkRequest()
            {
                Ledger = ledger,
                RequestBody = requestBody,
            };
        ...
        public async Task<Models.Requests.V2CreateTransactionResponse> CreateTransactionAsync(string ledger, V2PostTransaction v2PostTransaction, bool? dryRun = null, string? idempotencyKey = null)
        {
            var request = new V2CreateTransactionRequest()
            {
                Ledger = ledger,
        ...
        public async Task<Models.Requests.V2RevertTransactionResponse> RevertTransactionAsync(string ledger, BigInteger id, bool? force = null, bool? atEffectiveDate = null)
        {
            var request = new V2RevertTransactionRequest()
            {
                Ledger = ledger,
                Id = id,
                Force = force,
